...
#include "../source/QPS/Evaluator/RelationshipEvaluator/AffectsEvaluator.h"
...
namespace UnitTesting
{
	...
	public:
		TEST_METHOD(evaluateAffects_NoInformation)
		{
			...
			AffectsEvaluator affectsEvaluator = AffectsEvaluator(lhsRef, rhsRef, map,
				*pkbQueryApi, getAllEvaluator, affectsProcessor);
			QueryResult result = affectsEvaluator.evaluate();
		...
		TEST_METHOD(evaluateAffects_hasInformation_doubleInteger)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			...
			pkbStorageApi->setRelationship(RelationshipType::USES_S, 1, vec2);
		...
		TEST_METHOD(evaluateAffects_hasInformation_doubleWildCard)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_doubleSynonym)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftSynonym_rightInteger)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftInteger_rightSynonym)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftInteger_rightWildCard)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftWildcard_rightInteger)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftSynonym_rightWildcard)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftWildcard_rightSynonym)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_leftSynonym_rightInteger_validNext)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateAffects_hasInformation_doubleSameSynonym)
		{
			pkbStorageApi->insertProc(1, 2, "test");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
