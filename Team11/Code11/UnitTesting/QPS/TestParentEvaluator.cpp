...
#include "QPS/Evaluator/RelationshipEvaluator/ParentEvaluator.h"
...
namespace UnitTesting
{
	...
	public:
		TEST_METHOD(evaluateParent_NoInformation)
		{
			...
			ParentEvaluator parentEvaluator = ParentEvaluator(lhsRef, rhsRef, map, *pkbQueryApi, getAllEvaluator);
