...
#include "../source/QPS/Evaluator/RelationshipEvaluator/UsesSEvaluator.h"

using namespace Microsoft::VisualStudio::CppUnitTestFramework;

namespace UnitTesting
{
	TEST_CLASS(TestUsesSEvaluator)
	{
	private:
		PKB* pkb;
	...
	public:
		TEST_METHOD(evaluateUsesS_NoInformation)
		{
			...
			UsesSEvaluator UsesSEvalautor = UsesSEvaluator(lhsRef, rhsRef, map, *pkbQueryApi, getAllEvaluator);
			QueryResult result = UsesSEvalautor.evaluate();
		...
		TEST_METHOD(evaluateUsesS_NoModifies)
		{
			...
			pkbStorageApi->setRelationship(RelationshipType::USES_S, 1, modifiedVars);
		...
		TEST_METHOD(evaluateUsesS_lhsSyn_rhsSyn_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateUsesS_lhsSyn_rhsWildcard_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			...
			pkbStorageApi->setRelationship(RelationshipType::USES_S, 8, modifiedVars);
		...
		TEST_METHOD(evaluateUsesS_lhsSyn_rhsIdent_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateUsesS_lhsSyn_rhsIdent_validOutput_2)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertWhileContainer(1, 4);
			...
			pkbStorageApi->setRelationship(RelationshipType::USES_S, 2, modifiedVars2);
		...
		TEST_METHOD(evaluateUsesS_lhsInt_rhsSynonym_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateUsesS_lhsInt_rhsWildcard_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateUsesS_lhsInt_rhsIdent_validOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
		...
		TEST_METHOD(evaluateUsesS_lhsInt_rhsIdent_validNoOutput)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
		...
		TEST_METHOD(evaluateUsesS_lhsWildcard_rhsIdent_invalid)
		{
			pkbStorageApi->insertProc(1, 4, "testMain");
			pkbStorageApi->insertAssign(1, "x");
			pkbStorageApi->insertStmt(1, StatementType::ASSIGN_STMT);
			...
			auto wrapperResult = [&UsesSEvalautor, this] {
				QueryResult result = UsesSEvalautor.evaluate();
			};
